...
public class TwoFragment extends Fragment {
    ...
    public  void carregarLista(){
        ...
        try {
            this.listaDisciplinas = disciplinasDAO.listar();
            adapter = new ArrayAdapter<Disciplina>(this.getContext(), adapterLayout, listaDisciplinas);
            mListView = (ListView)getActivity().findViewById(R.id.listViewTerca);
